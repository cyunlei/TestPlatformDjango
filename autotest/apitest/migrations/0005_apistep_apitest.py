# Generated by Django 3.2.9 on 2021-12-18 14:47
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('apitest', '0004_auto_20211218_1643'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Prdoct', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='product.product')),
            ],
        ),
        migrations.CreateModel(
            name='ApiStep',
            fields=[
                ...
                ('apimetod', models.CharField(choices=[('patch', 'patch'), ('put', 'put'), ('get', 'get'), ('delete', 'delete'), ('post', 'post')], default='get', max_length=200, null=True, verbose_name='请求方法')),
                ...
                ('apistatus', models.BooleanField(max_length=200, verbose_name='是否通过')),
                ('create_time', models.DateTimeField(auto_now=True, verbose_name='创建时间')),
