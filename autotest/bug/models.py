...
class Bug(models.Model):
    ...
    # 解决状态
    bugstatus = models.CharField(verbose_name='解决状态', max_length=200, null=True, choices=BUG_STATUS, default='激活')
    BUG_LEVEL = (('1', '1'), ('2', '2'), ('3', '3'))
    buglevel = models.CharField(verbose_name='严重程度', max_length=200, choices=BUG_LEVEL, default=3, null=True)
